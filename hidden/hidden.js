...
async function onHide() {
    ...
    try {
        ...
        // Corrected link to your 'create' page
        error("The hidden URL appears corrupted. It must be a password-protected Link Lock URL. <a href=\"https://animastertamil.github.io/link-lock\">Click here to add a password.</a>");
        return;
...
function main() {
    if (window.location.hash) {
        document.querySelector("#encrypted-url").value =
            // Corrected URL to your 'create' page for autofill
            `https://animastertamil.github.io/link-lock/create/${window.location.hash}`;
