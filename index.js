        ...
        unlockButton.addEventListener("click", async () => {
            ...
            try {
                ...
                document.querySelector("#no-redirect").href =
                    `https://animastertamil.github.io/link-lock/decrypt/#${hash}`;

                // Set the "create hidden bookmark" URL appropriately
                document.querySelector("#hidden").href =
                    `https://animastertamil.github.io/link-lock/hidden/#${hash}`;
                return;
            }
            ...
            try {
                ...
                if (!(urlObj.protocol == "http:" || urlObj.protocol == "https:" || urlObj.protocol == "magnet:")) {
                    error(`The link uses a non-hypertext protocol, which is not allowed. ` + `The URL begins with "${urlObj.protocol}" and may be malicious.`);
                    return;
                }
